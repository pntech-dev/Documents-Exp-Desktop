    ...
    "0.2.12": [
        {
            ...
            "items": [
                "Экранные уведомления теперь надёжнее исчезают при ручном закрытии.",
                "Стек уведомлений сохраняет корректное расположение при частом закрытии и появлении новых сообщений.",
                "Улучшена общая отзывчивость интерфейса в сценариях с большим числом уведомлений.",
            ],
        },
    ],
}
