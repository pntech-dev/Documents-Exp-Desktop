...
RELEASE_NOTES = {
    "0.2.5": [
        {
            "title": "Совместимость настроек",
            "items": [
                "Добавлена автоматическая миграция старого формата фильтров поиска в текущий формат.",
                "Унифицирована схема фильтров по умолчанию с текущим поведением главного окна.",
                "Добавлены проверки миграции настроек и согласованности схемы.",
            ],
        },
    ],
}
