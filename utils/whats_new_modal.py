    ...
    "0.2.14": [
        {
            ...
            "items": [
                "Усилены проверки безопасности сессии при завершении входа и регистрации.",
                "Приложение больше не продолжает авторизацию, если данные сессии неполные.",
                "Снижен риск нестабильного состояния входа после успешного ответа сервера.",
            ],
        },
    ],
}
