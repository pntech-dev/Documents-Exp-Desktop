...
RELEASE_NOTES = {
    "0.2.6": [
        {
            "title": "Качество обработки ошибок",
            "items": [
                "Улучшено извлечение деталей API-ошибок из разных форматов ответа.",
                "Добавлен устойчивый fallback для HTTP-ответов без JSON.",
                "Добавлены проверки для валидационных ошибок списком и универсального fallback-сообщения.",
            ],
        },
    ],
}
