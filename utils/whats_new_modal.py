...
RELEASE_NOTES = {
    "0.2.8": [
        {
            "title": "Улучшения авторизации",
            "items": [
                "Формы входа и восстановления аккаунта теперь стабильнее реагируют на невалидный ввод.",
                "Кнопки действий сразу блокируются, если введённые данные не проходят проверку.",
                "При отмене ввода кода подтверждения процесс теперь корректно завершается без лишних ошибок.",
            ],
        },
    ],
}
