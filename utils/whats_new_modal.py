...
RELEASE_NOTES = {
    "0.2.10": [
        {
            "title": "Улучшения стабильности API",
            "items": [
                "Повышена стабильность в редком случае, когда сервер возвращает неожиданный пустой ответ.",
                "Теперь приложение корректно обрабатывает такой сценарий без срыва рабочего процесса.",
                "Улучшена надёжность фоновой загрузки и обновления данных.",
            ],
        },
    ],
}
