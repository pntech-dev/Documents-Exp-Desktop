...
RELEASE_NOTES = {
    "0.2.11": [
        {
            "title": "Улучшения обновления",
            "items": [
                "Отмена скачивания обновления теперь обрабатывается надёжнее.",
                "Окно обновления больше не зависает в редком сценарии отмены в конце загрузки.",
                "Временные файлы установщика после отмены очищаются стабильнее.",
            ],
        },
    ],
}
