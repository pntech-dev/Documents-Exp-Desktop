...
RELEASE_NOTES = {
    "0.2.15": [
        {
            "title": "Улучшения панели инструментов",
            "items": [
                "Исправлено поведение кнопки `Обновить`: выбранные отдел и категория теперь сохраняются.",
                "После нажатия `Обновить` таблица корректно перезагружается для текущего выбора.",
                "Новые отделы и категории появляются после обновления без сброса текущего контекста.",
            ],
        },
    ],
}
