...
RELEASE_NOTES = {
    "0.2.3": [
        {
            "title": "Стабильность конфигурации",
            "items": [
                "Усилена обработка config.yaml при пустом содержимом.",
                "Добавлена защита от некорректного формата конфигурации для предотвращения сбоев на старте и в рантайме.",
                "Добавлены проверки для пустой и структурно некорректной конфигурации.",
            ],
        },
    ],
}
