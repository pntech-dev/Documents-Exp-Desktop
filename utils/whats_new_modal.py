...
RELEASE_NOTES = {
    "0.2.7": [
        {
            "title": "Обновление стабильности",
            "items": [
                "Открытие документа стало стабильнее, даже если загрузка данных временно недоступна.",
                "Сообщения об ошибках в этом сценарии стали понятнее и менее навязчивыми.",
                "Восстановление сессии в редких сбойных ситуациях после перезапуска работает надёжнее.",
            ],
        },
    ],
}
