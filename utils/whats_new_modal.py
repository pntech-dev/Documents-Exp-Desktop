    ...
    "0.2.13": [
        {
            ...
            "items": [
                "Повышена стабильность системы уведомлений при переключении и переоткрытии окон.",
                "В редком сценарии без активного главного окна уведомления теперь сбрасываются безопасно.",
                "Снижен риск сбоев интерфейса при переходах между экранами.",
            ],
        },
    ],
}
